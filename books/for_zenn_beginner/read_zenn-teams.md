---
title: "❗【重要】Zennの利用規約とプライバシーポリシーを読む"
---
...
### ❗ブックマークは、[表紙ページ](https://zenn.dev/nomuraya/books/(for_zenn_beginner))にお願いします。
...
# 読者に求める要件
- この記事は`2022年1月21日現在の時点での規約を見ている`事をご認識ください
  - 最終更新日の規約を見ているのではないのでご注意！（ぱっと見は変化がなかったです）
- 今後改訂が行われた場合は、速やかに対応するつもりです
- この記事では私にとって重要だと思った部分を特に解説していますが、必ず原文をご覧になってからご覧ください。
  - 我々の業界？でいうところのネタバレ回避……ではありませんが、そのようなものだと考えてもらえると話が早くて助かります。

# 章の目的
```
みんなでちゃんと利用規約を読んで、正しく使おう！
（特に有料コンテンツの販売と購入）
```
...
### 特商法(特定商取引法)基づく表記について
大事な話なので書いておきます。
以下２項の条件に当てはまる場合は登録が必要です。

- `特定商取引法の定める「販売事業者」に該当`する方
  - [販売事業者とは？(外部PDF)](https://www.no-trouble.caa.go.jp/pdf/20120401ra01.pdf)
- `コンテンツを販売する場合`（有料で本を出す）

> 本サービスでコンテンツを販売する利用者（以下「販売者」といいます。）

と、勘違いしてしまいやすいので注意しましょう。
つまり、`特商法の定める販売事業者でない方`は不要です。

特商法の表記に拘る理由については、「特商法 個人情報流出」あたりで検索してみると情報がザクザク！[^3]

[^3]: 【特商法と個人情報】これを言うと何なんですが、人の恨みを買うやり方をしておいて自分だけ個人情報ガーはないでしょう、と私は思います。悪どい事をしなければ個人情報を悪用しようと考える人も増えないはず（いないとは言っていない）
